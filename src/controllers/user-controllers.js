...
const { QueryTypes, Op, DataTypes } = require('sequelize');
...
exports.queryInterface = async (req,res,next) => {
    try {
        queryInterface.addColumn('users', 'fatherName', { type: DataTypes.STRING });
